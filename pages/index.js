...
//         डेमो मतदानासाठी घड्याळ निशाणी समोरील निळे बटन दाबावे
//     </button>
//     <p className="text-md font-medium mt-6">
//         मतदानाच्या दिवशी सुद्धा <span className="font-bold">घड्याळ</span> या चिन्हासमोरील बटन दाबून <span className="font-bold">भरत मारुती गोगावले</span> यांना प्रचंड मतांनी विजयी करा !
//     </p>
...
//         “रेल्वे इंजिन” या चिन्हासमोरील बटन दाबून प्रचंड मतांनी विजयी करा.
//     </p>
...
//     <thead>
//       <tr>
//         <th className="border-2-2 border-black p-2 font-semibold">अ.क्र</th>
//         <th className="border-2-2 border-black p-2 font-semibold">उमेदवाराचे नाव</th>
//         <th className=""></th>
//         <th className="border-2-2 border-black p-2 font-semibold">चिन्ह</th>
//         <th className="border-2-2 border-black  font-semibold bg-orange-100">बटन</th>
//       </tr>
//     </thead>
//     <tbody>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black text-center">
//         </td>
//         <td className="border-2-2 border-black  bg-orange-100 text-center  ">
...
//      <tr>
//       <td className="border-2-2 border-black p-2 text-center text-xl font-bold">२.</td>
//       <td className="border-2-2 border-black  text-center text-sm font-bold w-65">
//         भरत मारुती गोगावले.
//       </td>
//       <td className="border-2-2 border-black text-center">
...
//         </td>
//       <td className="border-2-2 border-black p-4 bg-orange-100 text-center flex">
//         <div
...
//       <tr>
//         <td className="border-2-2 border-black  text-center">३.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">४.</td>
//         <td className="border-2-2 border-black  text-center"></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
//         <td className="border-2-2 border-black bg-orange-100 text-center  ">
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">५.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">६.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">७.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">८.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black text-center">९.</td>
//         <td className="border-2-2 border-black"></td>
//         <td className="border-2-2 border-black"></td>
//         <td className="border-2-2 border-black text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१०.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">११.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१२.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१३.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१४.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१५.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black  text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-gra text-center">१६.</td>
//         <td className="border-2-2 border-gra"></td>
//         <td className="border-2-2 border-gra"></td>
//         <td className="border-2-2 border-gra text-center">
//         </td>
//         <td className="border-2-2 border-gra bg-orange-100 text-center  ">
//         <div className="w-6 h-6 rounded-full border border-black inline-block mr-2"></div>
//           <button className="bg-blue-900 text-white rounded-full px-8 py-4 shadow-lg"onClick={handleButtonClick1}></button>
//         </td>
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black text-center">१७.</td>
//         <td className="border-2-2 border-black"></td>
//         <td className="border-2-2 border-black"></td>
//         <td className="border-2-2 border-black text-center">
//         </td>
...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-black  text-center">१८.</td>
//         <td className="border-2-2 border-black "></td>
//         <td className="border-2-2 border-black "></td>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.सचिन पाटील.</title>
        <meta name="description" content="Generated by Shakkti_Ai" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        ...
        <p className="text-md font-medium mt-6">
          मतदानाच्या दिवशी सुद्धा <span className="font-bold">घड्याळ</span> या
          चिन्हासमोरील बटन दाबून{" "}
          <span className="font-bold">श्री.सचिन सुधाकर पाटील</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
      ...
      <div className="bg-yellow-400 text-center py-4 px-6">
        <p className="text-black font-bold text-3xl">
          “घड्याळ” या चिन्हासमोरील बटन दाबून प्रचंड मतांनी विजयी करा.
        </p>
        <p className="text-black text-xl mt-2">
          मतदान दिनांक २० नोव्हेंबर २०२४ स. ०७:०० ते सायं. ०६:००
        </p>
    ...
    <span className="flex items-center">
      ...
      <audio ref={(el) => (audioRefs.current.audio2 = el)} src="/sachinpatil.mp3" preload="auto"></audio>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center z-50">
                  <div className="relative">
                    ...
                    <img src='/Sachin.gif' alt="Full-screen" className="max-w-full max-h-full" />
                  </div>
                  <div>
                  {/* <a href="https://wa.link/92x71l">
                <button className="bg-green-500 text-white font-bold py-2 px-4 rounded-full flex items-center space-x-2">
